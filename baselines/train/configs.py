...
def get_experiment_config(args, default_config):
    if args.exp == 'pd_arena':
        ...
        raise Exception("Please set --exp to be one of ['pd_arena', 'al_harvest', 'clean_up', \
                        'territory_rooms','daycare','commons_harvest__partnership', 'commons_harvest__open','common_harvest_closed','commons_harvest__private_property_pc', 'commons_harvest__private_property','commons_harvest__open_disable_zapping', 'commons_harvest__open_abundance', 'commons_harvest__open_scarcity', 'commons_harvest__farmer']. Other substrates are not supported.")
